...
from backend.db.schemas.securite.securite_schemas import LogsSecuriteCreate, LogsSecuriteRead
from backend.services.securite.registre_securite_service import (
    creer_log_securite,
