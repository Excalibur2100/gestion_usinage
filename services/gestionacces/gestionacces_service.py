...
from db.schemas.gestion_acces_schemas import GestionAccesCreate, GestionAccesRead
...
def mettre_a_jour_gestion_acces(db: Session, id: int, data: GestionAccesCreate) -> Optional[GestionAcces]:
    """
